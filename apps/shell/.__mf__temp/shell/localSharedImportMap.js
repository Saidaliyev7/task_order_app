...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@shared/config": async () => {
          let pkg = await import("__mf__virtual/shell__prebuild___mf_0_shared_mf_1_config__prebuild__.js");
            return pkg;
        }
      ,
        "@shared/ui": async () => {
          let pkg = await import("__mf__virtual/shell__prebuild___mf_0_shared_mf_1_ui__prebuild__.js");
            return pkg;
        }
      ,
        "@shared/utils": async () => {
          let pkg = await import("__mf__virtual/shell__prebuild___mf_0_shared_mf_1_utils__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
      ...
      const usedShared = {
          ...
          "@shared/config": {
            ...
            async get () {
              if (false) {
                throw new Error(`Shared module '${"@shared/config"}' must be provided by host`);
              }
              usedShared["@shared/config"].loaded = true
              const {"@shared/config": pkgDynamicImport} = importMap
      ...
      const usedRemotes = [
                {
                  ...
                  name: "orders",
                  type: "module",
                  entry: "http://localhost:4301/assets/remoteEntry.js",
                  shareScope: "default",
                }
          ,
                {
                  ...
                  name: "inventory",
                  type: "module",
                  entry: "http://localhost:4302/assets/remoteEntry.js",
                  shareScope: "default",
                }
          ,
                {
                  entryGlobalName: "meals",
                  name: "meals",
                  type: "module",
                  entry: "http://localhost:4303/assets/remoteEntry.js",
                  shareScope: "default",
                }
